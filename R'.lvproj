...
<Project Type="Project" LVVersion="17008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Simulation Project" Type="Folder">
			<Item Name="Generate Graphics" Type="Folder">
				<Item Name="Arm_Graphic.vi" Type="VI" URL="../Desktop Simulation/Arm_Graphic.vi"/>
				<Item Name="Head Graphic.vi" Type="VI" URL="../Desktop Simulation/Head Graphic.vi"/>
			</Item>
			<Item Name="3d Test2.vi" Type="VI" URL="../Desktop Simulation/3d Test2.vi"/>
			<Item Name="Main Simulation.vi" Type="VI" URL="../Desktop Simulation/Main Simulation.vi"/>
		</Item>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Box_Boundary.vi" Type="VI" URL="../Box_Boundary.vi"/>
			<Item Name="Calibrated Oculus Data.ctl" Type="VI" URL="../Calibrated Oculus Data.ctl"/>
			<Item Name="Calibration Control.ctl" Type="VI" URL="../Calibration Control.ctl"/>
			<Item Name="Control_Calibration.vi" Type="VI" URL="../Control_Calibration.vi"/>
			<Item Name="Process_Oculus_Data - Rufus.vi" Type="VI" URL="../Process_Oculus_Data - Rufus.vi"/>
			<Item Name="Raw Oculus Data.ctl" Type="VI" URL="../Raw Oculus Data.ctl"/>
			<Item Name="Read_Oculus_data.vi" Type="VI" URL="../Read_Oculus_data.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build"/>
	</Item>
	<Item Name="Rufus" Type="RT myRIO">
		<Property Name="alias.name" Type="Str">Rufus</Property>
		<Property Name="alias.value" Type="Str">130.64.190.55</Property>
...
AddOutputFilter chunkFilter
		...
		<Item Name="Data Calibration" Type="Folder">
			<Item Name="Process_Oculus_Data - Rufus.vi" Type="VI" URL="../Process_Oculus_Data - Rufus.vi"/>
			<Item Name="Read_Oculus_data.vi" Type="VI" URL="../Read_Oculus_data.vi"/>
			<Item Name="Select_Calibration_Control.vi" Type="VI" URL="../Select_Calibration_Control.vi"/>
			<Item Name="Control_Calibration.vi" Type="VI" URL="../Control_Calibration.vi"/>
		</Item>
		<Item Name="Head" Type="Folder">
			<Item Name="Head_Servo_Write.vi" Type="VI" URL="../Head_Servo_Write.vi"/>
			<Item Name="manual head control.vi" Type="VI" URL="../manual head control.vi"/>
			<Item Name="Head_OrientationBoundary.vi" Type="VI" URL="../Head_OrientationBoundary.vi"/>
		</Item>
		<Item Name="uArm" Type="Folder">
			<Item Name="Boundary" Type="Folder">
				<Item Name="BoundaryAndCorrection.vi" Type="VI" URL="../BoundaryAndCorrection.vi"/>
				<Item Name="Box_Boundary.vi" Type="VI" URL="../Box_Boundary.vi"/>
			</Item>
			<Item Name="Connect_to_uArm.vi" Type="VI" URL="../Connect_to_uArm.vi"/>
			<Item Name="Uarm_Right_Hand_Follow.vi" Type="VI" URL="../Uarm_Right_Hand_Follow.vi"/>
			<Item Name="uArm_Wrist_Servo_Write.vi" Type="VI" URL="../uArm_Wrist_Servo_Write.vi"/>
			<Item Name="Wait_for_blank_buffer.vi" Type="VI" URL="../Wait_for_blank_buffer.vi"/>
			<Item Name="HomeUarm.vi" Type="VI" URL="../HomeUarm.vi"/>
			<Item Name="Uarm Initialize.vi" Type="VI" URL="../Uarm Initialize.vi"/>
			<Item Name="uArm_SelectGCode.vi" Type="VI" URL="../uArm_SelectGCode.vi"/>
			<Item Name="Close_uArm.vi" Type="VI" URL="../Close_uArm.vi"/>
		</Item>
		<Item Name="Test Codes" Type="Folder">
			<Item Name="simple_udp_receiver.vi" Type="VI" URL="../simple_udp_receiver.vi"/>
			<Item Name="Servo Tester.vi" Type="VI" URL="../Servo Tester.vi"/>
			<Item Name="uArm_SendGCode.vi" Type="VI" URL="../uArm_SendGCode.vi"/>
			<Item Name="ControlHeadServoCalibration.vi" Type="VI" URL="../ControlHeadServoCalibration.vi"/>
			<Item Name="UarmTestRead.vi" Type="VI" URL="../UarmTestRead.vi"/>
			<Item Name="Head Filter Tests.vi" Type="VI" URL="../Head Filter Tests.vi"/>
			<Item Name="Head_tester.vi" Type="VI" URL="../Head_tester.vi"/>
			<Item Name="test pen.vi" Type="VI" URL="../test pen.vi"/>
			<Item Name="Move_Tester.vi" Type="VI" URL="../Move_Tester.vi"/>
		</Item>
		<Item Name="Machine Control Toolkit" Type="Folder">
			<Item Name="Connect to Machine .vi" Type="VI" URL="../Machine Control Toolkit/Connect to Machine .vi"/>
			<Item Name="Disconnect from Machine.vi" Type="VI" URL="../Machine Control Toolkit/Disconnect from Machine.vi"/>
			<Item Name="Machine Read_Write Test.vi" Type="VI" URL="../Machine Control Toolkit/Machine Read_Write Test.vi"/>
			<Item Name="Read from Machine.vi" Type="VI" URL="../Machine Control Toolkit/Read from Machine.vi"/>
			<Item Name="Write to Machine .vi" Type="VI" URL="../Machine Control Toolkit/Write to Machine .vi"/>
			<Item Name="Move to Position.vi" Type="VI" URL="../Machine Control Toolkit/Move to Position.vi"/>
		</Item>
		...
		<Item Name="Move - DC" Type="Folder">
			<Item Name="Calculate_DCMotor_Spin.vi" Type="VI" URL="../Calculate_DCMotor_Spin.vi"/>
			<Item Name="Move_DCMotors.vi" Type="VI" URL="../Move_DCMotors.vi"/>
			<Item Name="Throttle.vi" Type="VI" URL="../Throttle.vi"/>
		</Item>
		<Item Name="Main Rufus.vi" Type="VI" URL="../Main Rufus.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
			...
			<Item Name="Lossy Stream-t&apos;Calibrated Oculus Data.ctl&apos;.lvlib" Type="Library" URL="/&lt;extravilib&gt;/ChannelInstances/Lossy Stream-t&apos;Calibrated Oculus Data.ctl&apos;.lvlib"/>
	...
	<Item Name="Rachel" Type="RT myRIO">
		<Property Name="alias.name" Type="Str">Rachel</Property>
...
AddOutputFilter chunkFilter
		...
		<Property Name="target.webservices.ValidTimestampWindow" Type="Int">15</Property>
		<Item Name="Data Calibration" Type="Folder">
			<Item Name="Process_Oculus_Data - Rachel.vi" Type="VI" URL="../Process_Oculus_Data - Rachel.vi"/>
		</Item>
		<Item Name="Test Codes" Type="Folder">
			<Item Name="DCmotor Test.vi" Type="VI" URL="../DCmotor Test.vi"/>
			<Item Name="Rachel_Wheel_Test.vi" Type="VI" URL="../Rachel_Wheel_Test.vi"/>
			<Item Name="Rachel_Wheel_TestV2.vi" Type="VI" URL="../Rachel_Wheel_TestV2.vi"/>
		</Item>
		<Item Name="Move - Servo" Type="Folder">
			<Item Name="Move_Omni_Wheels_Servo.vi" Type="VI" URL="../Move_Omni_Wheels_Servo.vi"/>
			<Item Name="Movement_Picture_ClusterInput.vi" Type="VI" URL="../Movement_Picture_ClusterInput.vi"/>
			<Item Name="Calculate_Servo_Spin.vi" Type="VI" URL="../Calculate_Servo_Spin.vi"/>
			<Item Name="Movement Picture.vi" Type="VI" URL="../Movement Picture.vi"/>
		</Item>
		<Item Name="Main Rachel.vi" Type="VI" URL="../Main Rachel.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
				<Item Name="Calculate Clock Settings.vi" Type="VI" URL="/&lt;vilib&gt;/myRIO/Common/Instrument Driver Framework/Utilities/vis/Calculate Clock Settings.vi"/>
				<Item Name="Calculate Frequency (Normal Mode).vi" Type="VI" URL="/&lt;vilib&gt;/myRIO/Common/Instrument Driver Framework/Utilities/vis/Calculate Frequency (Normal Mode).vi"/>
